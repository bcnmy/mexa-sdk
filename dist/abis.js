...
exports.erc20Eip2612Abi = exports.daiAbi = exports.gnosisSafeProxyFactoryAbi = exports.gnosisSafeAbi = exports.entryPointAbi = exports.walletFactoryAbi = exports.baseWalletAbi = exports.eip2771BaseAbi = exports.biconomyForwarderAbi = void 0;
...
exports.baseWalletAbi = [{
        ...
        inputs: [{
                components: [{ internalType: 'address', name: 'to', type: 'address' }, { internalType: 'uint256', name: 'value', type: 'uint256' }, { internalType: 'bytes', name: 'data', type: 'bytes' }, { internalType: 'enumEnum.Operation', name: 'operation', type: 'uint8' }, { internalType: 'uint256', name: 'targetTxGas', type: 'uint256' }], internalType: 'structWalletStorage.Transaction', name: '_tx', type: 'tuple',
            }, {
                components: [{ internalType: 'uint256', name: 'baseGas', type: 'uint256' }, { internalType: 'uint256', name: 'gasPrice', type: 'uint256' }, { internalType: 'address', name: 'gasToken', type: 'address' }, { internalType: 'addresspayable', name: 'refundReceiver', type: 'address' }], internalType: 'structWalletStorage.FeeRefund', name: 'refundInfo', type: 'tuple',
        ...
        inputs: [{ internalType: 'addresspayable', name: 'dest', type: 'address' }, { internalType: 'uint256', name: 'amount', type: 'uint256' }], name: 'transfer', outputs: [], stateMutability: 'nonpayable', type: 'function',
    }, {
...
exports.walletFactoryAbi = [{ inputs: [{ internalType: 'address', name: '_baseImpl', type: 'address' }], stateMutability: 'nonpayable', type: 'constructor' }, {
        anonymous: false,
        inputs: [{
...
exports.entryPointAbi = [{ inputs: [{ internalType: 'address', name: '_create2factory', type: 'address' }, { internalType: 'uint256', name: '_paymasterStake', type: 'uint256' }, { internalType: 'uint32', name: '_unstakeDelaySec', type: 'uint32' }], stateMutability: 'nonpayable', type: 'constructor' }, { inputs: [{ internalType: 'uint256', name: 'opIndex', type: 'uint256' }, { internalType: 'address', name: 'paymaster', type: 'address' }, { internalType: 'string', name: 'reason', type: 'string' }], name: 'FailedOp', type: 'error' }, {
        ...
        name: 'getDepositInfo',
        outputs: [{
                components: [{ internalType: 'uint112', name: 'amount', type: 'uint112' }, { internalType: 'uint32', name: 'unstakeDelaySec', type: 'uint32' }, { internalType: 'uint64', name: 'withdrawTime', type: 'uint64' }], internalType: 'structStakeManager.DepositInfo', name: 'info', type: 'tuple',
            }],
        stateMutability: 'view',
        type: 'function',
    }, {
        ...
        inputs: [{
                components: [{ internalType: 'address', name: 'sender', type: 'address' }, { internalType: 'uint256', name: 'nonce', type: 'uint256' }, { internalType: 'bytes', name: 'initCode', type: 'bytes' }, { internalType: 'bytes', name: 'callData', type: 'bytes' }, { internalType: 'uint256', name: 'callGas', type: 'uint256' }, { internalType: 'uint256', name: 'verificationGas', type: 'uint256' }, { internalType: 'uint256', name: 'preVerificationGas', type: 'uint256' }, { internalType: 'uint256', name: 'maxFeePerGas', type: 'uint256' }, { internalType: 'uint256', name: 'maxPriorityFeePerGas', type: 'uint256' }, { internalType: 'address', name: 'paymaster', type: 'address' }, { internalType: 'bytes', name: 'paymasterData', type: 'bytes' }, { internalType: 'bytes', name: 'signature', type: 'bytes' }], internalType: 'structUserOperation', name: 'op', type: 'tuple',
            }, { internalType: 'addresspayable', name: 'beneficiary', type: 'address' }],
        name: 'handleOp',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
        ...
        inputs: [{
                components: [{ internalType: 'address', name: 'sender', type: 'address' }, { internalType: 'uint256', name: 'nonce', type: 'uint256' }, { internalType: 'bytes', name: 'initCode', type: 'bytes' }, { internalType: 'bytes', name: 'callData', type: 'bytes' }, { internalType: 'uint256', name: 'callGas', type: 'uint256' }, { internalType: 'uint256', name: 'verificationGas', type: 'uint256' }, { internalType: 'uint256', name: 'preVerificationGas', type: 'uint256' }, { internalType: 'uint256', name: 'maxFeePerGas', type: 'uint256' }, { internalType: 'uint256', name: 'maxPriorityFeePerGas', type: 'uint256' }, { internalType: 'address', name: 'paymaster', type: 'address' }, { internalType: 'bytes', name: 'paymasterData', type: 'bytes' }, { internalType: 'bytes', name: 'signature', type: 'bytes' }], internalType: 'structUserOperation[]', name: 'ops', type: 'tuple[]',
            }, { internalType: 'addresspayable', name: 'beneficiary', type: 'address' }],
        name: 'handleOps',
        outputs: [],
        stateMutability: 'nonpayable',
        ...
        inputs: [{ internalType: 'addresspayable', name: 'withdrawAddress', type: 'address' }, { internalType: 'uint256', name: 'withdrawAmount', type: 'uint256' }], name: 'withdrawTo', outputs: [], stateMutability: 'nonpayable', type: 'function',
