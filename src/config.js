...
config.PAYMENT_TOKEN_CONTRACT = ZERO_ADDRESS;
config.PAYMENT_TOKEN_AMOUNT = 0;
config.NONCE_BATCH_ID = 0;
config.EXPIRY = 0;
config.BASE_GAS = 0;
config.RELAYER_ADDRESS = ZERO_ADDRESS;
config.TOKEN_CONTRACT_ADDRESS = ZERO_ADDRESS;
config.DEFAULT_RELAYER_PAYMENT_TOKEN_ADDRESS = ZERO_ADDRESS;
